...
test_cases = [
    (
        "I'm starting on my coding project now",
        "finish my coding project",
        False,
    ),
    (
        "I have finished my coding proejct!",
        "finish my coding project",
        True,
    ),
    ...
    (
        "I just spoke with the vendor. He said he will update hist timeline",
        "talk to the vendor",
        True,
    ),
...
@pytest.mark.parametrize(
    "action_text,expected_todo_text,mark_complete", test_cases
)
def test_find_todo(
    sample_todos, action_text, expected_todo_text, mark_complete
):
