...
from ..db import ToolCall, Action, Todo
...
def find_todo(
    input_obj: ToolCall | Action | Todo,
...
def get_find_todo_tool(
    ...
    if include_mark_complete:
        params["properties"]["mark_complete"] = {
            "type": "boolean",
            "description": "Whether to mark the todo as complete, as opposed to beginning or remarking on it. ",
        }
        params["required"].append("mark_complete")
